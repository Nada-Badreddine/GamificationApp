...
const Orders = () => {
    ...
    const { loading, data } = useQuery(GET_ORDERS_BY_USER, { variables: { id: userConecte } })
    if (loading) {
        return (
                        ...
                        <TableBody>
                            {data?.user?.orders?.map((row) => (
                                <StyledTableRow key={row.id}>
                                    ...
                                    <StyledTableCell align="center">{row.TotalCart}</StyledTableCell>
                                    <StyledTableCell align="center">{row.status}</StyledTableCell>
                                    <StyledTableCell align="center">{row.created_at}</StyledTableCell>
                                    <StyledTableCell align="center"><button>details</button></StyledTableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
                    </Table>
